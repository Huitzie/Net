...
const SearchResultsContent = () => {
  ...
  const vendorsQuery = useMemoFirebase(() => {
    ...
    let q = collection(firestore, 'vendors');
    ...
    // Keyword search would require a more complex solution like Algolia/Elasticsearch
    // or a more complex Firestore query strategy. Not implemented for this example.

    return q;
  }, [firestore, state, city, categoryId, keyword]);
  ...
  const totalFound = vendors?.length || 0;
...
const SearchFormWrapper = () => {
    ...
    return <SearchForm initialValues={{ state, city, category: categoryId, keyword }} />;
}
