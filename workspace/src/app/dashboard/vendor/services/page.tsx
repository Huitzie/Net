...
const ManageServicesPage: NextPage = () => {
  ...
  const servicesCollectionRef = useMemoFirebase(() => {
    ...
    return collection(firestore, 'users', user.uid, 'vendor', 'services');
  }, [firestore, user?.uid]);
  ...
  const handleDeleteService = (serviceId: string, serviceName: string) => {
    ...
    const serviceDocRef = doc(firestore, 'users', user.uid, 'vendor', 'services', serviceId);
